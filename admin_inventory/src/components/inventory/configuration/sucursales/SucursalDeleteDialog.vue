...
const deleteSucursal = async () => {
  ...
  try {
    ...
    console.log(resp);
    emit("deleteSucursal", props.sucursalSelected);
    onFormReset();
  } catch (error) {
    console.log(error);
  }
...
onMounted(() => {
    console.log(props.sucursalSelected);
})
        ...
        >
          <VRow>
            ...
            <VCol
              cols="12"
            >
            <p>¿Estas seguro de eliminar la SUCURSAL : {{ props.sucursalSelected.name }}?</p>
            </VCol>
